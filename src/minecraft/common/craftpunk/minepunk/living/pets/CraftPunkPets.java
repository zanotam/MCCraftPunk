...
@Mod(modid = CraftPunkPets.ID, name = CraftPunkPets.fullName, version = CraftPunkPets.VERSION)
@NetworkMod(clientSideRequired = false, serverSideRequired = false)
public class CraftPunkPets
{

	public static final String ID = "CraftPunkPets";
	public static final String VERSION = "1.0.0a";
	public static final String packageName = "common.craftpunk.minepunk.living.pets";
	public static final String fullName = "A Mod To Improve Pets In Minecraft";

	@Instance(ID)
	public static CraftPunkPets instance;
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		MinecraftForge.EVENT_BUS.register(new MobOcelotFearAdder());
