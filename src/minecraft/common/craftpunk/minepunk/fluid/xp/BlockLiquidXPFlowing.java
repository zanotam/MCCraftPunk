...
public class BlockLiquidXPFlowing extends BlockFlowing implements ILiquid
{


	protected BlockLiquidXPFlowing(int itemID)
	{
		super(itemID, Material.water);
	}
	...
	// the following is blatantly stolen from the buildcraft code
